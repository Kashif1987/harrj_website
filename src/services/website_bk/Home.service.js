...
//loginadmin
    return axios
    //  .post(API_URL + "login", insertData )
    .post(API_URL + "website/login/forgotpassword", insertData )
      .then((response) => {
        console.log("loging resp")
        console.log(response)
...
console.log(category_id)
 ...
 ProductList(auction_type) {
    return axios
      .get(API_URL + "website/product/list?auction_type="+auction_type)
      .then((response) => {
        return response.data;
      });
  }
  newyearList() {
    ...
    return axios
      .get(API_URL + "admin/year/listinvalue")
      .then((response) => {
        return response.data;
      });
  }
  ...
  BidderLstById(userId){
    ...
    return axios
    .post(API_URL + "api/bidder/bid_list_by_bidder_id",insertData,{ headers: authHeader() })
    .then((response) => {
      return response.data;
    });
   
  }
  ArchiveBid(bidid,bidderid){
    // http://185.185.83.220:3021:3021/admin/product/archive
    console.log("bid list")
    
    const insertData = new FormData();
   
    insertData.set('bidder_id', bidderid);
      insertData.set('bid_id', bidid);
    return axios
    .post(API_URL + "api/customer/delete_bid",insertData,{ headers: authHeader() })
    .then((response) => {
      return response.data;
    });
  }
  ...
  GoLiveProduct(title,name,description,keywords,category_id,sub_category_id,brand_id,model_id,country_id,city_id,start_date_time,end_date_time,
    auction_type,starting_price,high_price,final_price,refund,refund_days,youtube_link,product_img,video,start_time,end_time,year_id) {
    ...
    return axios
      .post(API_URL + "website/product/golive", insertData , { headers: authHeader() })
      .then((response) => {
        return response.data;
      });
      // 
  ...
  ProductAdd(title,name,description,keywords,category_id,sub_category_id,brand_id,model_id,country_id,city_id,start_date_time,end_date_time,
    auction_type,starting_price,high_price,final_price,refund,refund_days,youtube_link,product_img,video,start_time,end_time,year_id,custId) {
