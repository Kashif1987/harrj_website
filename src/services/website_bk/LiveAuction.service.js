...
class LiveAuctionService {
 ...
 LiveListFilter(auction_type,category_id,sub_category_id,brand_id,model_id,pricevalue,year,country_id,city_id,sort_by) {
  ...
  //   }
    return axios
      .get(API_URL + "admin/product/list?auction_type="+auction_type+"&category_id="+category_id+"&sub_category_id="+sub_category_id+"&brand_id="+brand_id+"&model_id="+model_id+"&max_price_filter="+pricevalue+"&year="+year+"&country_id="+country_id+"&city_id="+city_id+"&sort_by="+sort_by)
      .then((response) => {
  ...
  ClientProductList(customer_id){
    ...
    return axios
      .post(API_URL + "website/customer/list_myads",getData, { headers: authHeader() })
      .then((response) => {
        return response.data;
      });
  }
  AwardBid(customer_id,bid_id,bid_status,product_id){
    ...
    return axios
      .post(API_URL + "website/bidder/award_bid",getData, { headers: authHeader() })
      .then((response) => {
        return response.data;
      });
  }
  ProductwiseBidderList(product_id){
    ...
    getData.set('product_id', product_id);
    return axios
      .post(API_URL + "website/bidder/bidlist_by_productid",getData, { headers: authHeader() })
      .then((response) => {
        return response.data;
      });
  }
  ...
  MeetingStart(product_id, meeting_status) {
    ...
    updateData.set('product_id', product_id);
    updateData.set('meeting_status', meeting_status);

    return axios
      .post(API_URL + "website/product/update_meeting_status", updateData )
      .then((response) => {
        return response.data;
      });
  }
