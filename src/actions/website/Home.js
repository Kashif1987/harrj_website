...
export const Notifications = () => (dispatch) => {
  ...
  return homeService.Notifications().then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const GoogleLoginUser = (email_id) => (dispatch) => {
  return homeService.GoogleLogin(email_id).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const WebLogin = (name, email_id, mob_no, message) => (dispatch) => {
  return homeService.WebLogin(name, email_id, mob_no, message).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const UserLogin = (email_id, mobile_no, password,firebase_token) => (dispatch) => {
  return homeService.UserLogin(email_id, mobile_no, password,firebase_token).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const SubCategoryAllList = () => (dispatch) => {
  return homeService.SubCategoryAllList().then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const BrandAllList = () => (dispatch) => {
  return homeService.BrandAllList().then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const ModelAllList = () => (dispatch) => {
  return homeService.ModelAllList().then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const OTPCheck = (otp, email_id) => (dispatch) => {
  // console.log("action otp check")
  // console.log(otp)
  // console.log(email_id)
  return homeService.OTPCheck(otp, email_id).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const UpdatePassword = (email_id, passwd) => (dispatch) => {
  return homeService.UpdatePassword(email_id, passwd).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const ForgotPassword = (email_id) => (dispatch) => {
  return homeService.ForgotPassword(email_id).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const BidderLstById = (bidid) => (dispatch) => {
  return homeService.BidderLstById(bidid).then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
...
export const YearList = () => (dispatch) => {
  // console.log("action year list")
  return homeService.yearList().then(
    (response) => {
      dispatch({
        type: DATA_SUCCESS,
      });
