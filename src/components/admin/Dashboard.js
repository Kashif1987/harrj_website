...
console.log("DashboardCountFun");
    ...
    dispatch(DashboardCount())
      .then((response) => {
        ...
        console.log("DashboardCountFun response.data: ", response.data);
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row">
                            ...
                            {/* {this.props.t('hello.label')} */}
                                ...
                                <h3 class="page-title">{this.props.t('hello.label')}!</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item active">{this.props.t('adminDashboard')}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card dash-widget">
                                <div class="card-body">
                                    ...
                                    <div class="dash-widget-info">
                                        ...
                                        <span>{this.props.t('adminCusLs')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="card dash-widget">
                                <div class="card-body">
                                    <span class="dash-widget-icon"><i class="fa fa-user-secret" aria-hidden="true"></i></span>
                                    <div class="dash-widget-info">
                                        <h3>{this.state.listDashboardCountData['user_count']}</h3>
                                        <span>{this.props.t('adminBidLs')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                            <div class="card dash-widget">
                                <div class="card-body">
                                    <span class="dash-widget-icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span>
                                    <div class="dash-widget-info">
                                        <h3>{this.state.listDashboardCountData['product_count']}</h3>
                                        <span>{this.props.t('adminProduct')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card dash-widget">
                                <div class="card-body">
                                    ...
                                    <div class="dash-widget-info">
                                        ...
                                        <span>{this.props.t('LiveAuction')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card dash-widget">
                                <div class="card-body">
                                    ...
                                    <div class="dash-widget-info">
                                        ...
                                        <span>{this.props.t('regular_auction')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card dash-widget">
                                <div class="card-body">
                                    ...
                                    <div class="dash-widget-info">
                                        ...
                                        <span>{this.props.t('adminCategory')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>*/}
