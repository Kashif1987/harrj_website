      ...
      <React.Fragment>
        <div className="header">
         ...
         <center><a href="javascript:void(0)" className="logo"><img src={logoImg}  width="148%" height="60px" style={{ height: "60px",width: "148%"}} alt="" /></a></center>
          ...
          <a id="toggle_btn" onClick={this.handletoggleBtn}>
        ...
        <ul className="nav user-menu">
          ...
          {/* <li className="nav-item dropdown has-arrow flag-nav">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <a href="javascript:void(0);" className="dropdown-item" name ="French" onClick={() => changeLanguage('zh-HK')}>
          ...
          <li className="nav-item dropdown has-arrow main-drop">
            ...
            <div className="dropdown-menu">
              ...
              <a className="dropdown-item" onClick={this.showLogout}>{this.props.t('adminLogout')}</a>
            </div>
          </li>
        </ul>
        ...
        <div className="dropdown mobile-user-menu">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            {/*<a className="dropdown-item" href="profile.html">My Profile</a>
            <a className="dropdown-item" href="settings.html">Settings</a>*/}
            <a className="dropdown-item" onClick={()=>this.showLogout}>Logout</a>
          </div>
        </div>
