...
import AdBox from "./../website/parts/adBox";
toast.configure();
            ...
            <div className="content container-fluid">
              ...
              <div class="page-header">
                <div class="row align-items-center">
                  <div class="col">
                    <h3 class="page-title">{this.props.t('adminBidLs')}</h3>
                    <ul class="breadcrumb">
                      <li class="breadcrumb-item"><Link to={"/admin/dashboard"}>{this.props.t('adminDashboard')}</Link></li>
                      <li class="breadcrumb-item active">{this.props.t('adminBidLs')}</li>
                    </ul>
                  </div>
                    ...
                    <table id="example" className="table table-striped custom-table mb-0 datatable">
                      <thead>
                        <tr>
                          ...
                          <th>{this.props.t('adminBidLs')}</th>
                          <th>{this.props.t('Email')} </th>
                          <th>{this.props.t('Mobile')}</th>
                          <th>{this.props.t('Comments')}</th>
                          <th>{this.props.t('BidderTitle')}</th>
                              ...
                              <>
                                {this.state.listClientData && typeof this.state.listClientData !== "undefined" & this.state.listClientData.length > 0 && this.state.listClientData.map((itemClientList, l) => (
                                  <tr>
                                    ...
                                    {/* <td>{itemClientList.comment}</td> */}
                                    <td><a href={`/product/info/${itemClientList.product_id}`} target="_blank" >{itemClientList.comment}</a></td>
                                    {/* <td><a href={itemClientList.comment} target="_blank" >
{itemClientList.comment}</a></td> */}
                                    
                                    <td>{itemClientList.title}</td>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <textarea className="form-control" placeholder="Address" id="address" name="address" value={this.state.address} onChange={this.onChangeAddress} required onInvalid={(e) =>
                            e.target.setCustomValidity(
                              this.props.t("input_err_msg")
                            )
                          }
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" className="form-control" placeholder="Location" id="location" name="location" value={this.state.location} onChange={this.onChangeLocation} required onInvalid={(e) =>
                            e.target.setCustomValidity(
                              this.props.t("input_err_msg")
                            )
                          }
                                  ...
                                  <tbody formArrayName="items">
                                    ...
                                    <tr>
                                      <td className="assign-left">
                                        <input className="form-control site_name" name="site_name" value={this.state.maintenance_requirement} onChange={this.onChangeMaintenanceRequirement} required onInvalid={(e) =>
                                          e.target.setCustomValidity(
                                            this.props.t("input_err_msg")
                                          )
                                        }
                                      ...
                                      <td className="">
                                        <input className="form-control site_location" name="site_location" value={this.state.maintenance_desc} onChange={this.onChangeMaintenanceDesc} required onInvalid={(e) =>
                                          e.target.setCustomValidity(
                                            this.props.t("input_err_msg")
                                          )
                                        }
                                    ...
                                    {this.state.maintenanceMoreAddData.map((itemmaintenanceMoreAddData, midx) => (
                                      <tr>
                                        <td className="assign-left">
                                          <input className="form-control site_name" name="site_name" value={itemmaintenanceMoreAddData.maintenance_requirement} onChange={e => this.handleMaintenanceRequirementsChange(e, midx)} required onInvalid={(e) =>
                                            e.target.setCustomValidity(
                                              this.props.t("input_err_msg")
                                            )
                                          }
                  ...
                  <Form onSubmit={this.handleUpdateSubmit} ref={(c) => { this.Updateform = c; }}>
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label class="col-form-label">Address <span class="text-danger">*</span></label>
                          <textarea className="form-control" placeholder="Address" id="edit_address" name="edit_address" value={this.state.edit_address} onChange={this.onChangeEditAddress} required onInvalid={(e) =>
                            e.target.setCustomValidity(
                              this.props.t("input_err_msg")
                            )
                          }
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label class="col-form-label">Location <span class="text-danger">*</span></label>
                          <input type="text" className="form-control" placeholder="Location" id="edit_location" name="edit_location" value={this.state.edit_location} onChange={this.onChangeEditLocation} required onInvalid={(e) =>
                            e.target.setCustomValidity(
                              this.props.t("input_err_msg")
                            )
                          }
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label class="col-form-label">Pincode <span class="text-danger">*</span></label>
                          <input type="number" className="form-control" placeholder="Pincode" id="edit_pincode" name="edit_pincode" value={this.state.edit_pincode} onChange={this.onChangeEditPincode} required onInvalid={(e) =>
                            e.target.setCustomValidity(
                              this.props.t("input_err_msg")
                            )
                          }
